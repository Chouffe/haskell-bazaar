(defproject haskell-bazaar-frontend "0.1.0-SNAPSHOT"
  ...
  :dependencies [[org.clojure/clojure "1.9.0"]
                 ...
                 [cljsjs/semantic-ui-react "0.83.0-0" :exclusions [cljsjs/react]]
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "haskell-bazaar-frontend.core/on-js-reload"
                ...
                :compiler {:main haskell-bazaar-frontend.core
